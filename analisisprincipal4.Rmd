...
```
Los tres modelos alternativos tienen un valor finito de desviación lo que indica que el modelo converge correctamente y que no tenemos problemas evidentes de ajuste. 
Los valores reducidos del psudo-$R^2$ nos indican que los modelos mejoran al modelo nulo, lo que sugiere que los modelos tienen capacidad explicativa real.
