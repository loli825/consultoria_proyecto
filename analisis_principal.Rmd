...
Se incorpora la variable "fecha_est" mediante spline y su covariable de incertidumbre "fecha_ancho", comparando especificación lineal vs flexible (spline).

```{r}
library(splines)

# Transformación log(fecha_ancho)
...
Se incorporan las variables "soporte" y "tecnica" para evaluar si aporta infomración adicional, una vez controlado los efectos de datación (Bloque 1) y morfología (Bloque 2).  Se evaluará adicionalmente la inclusión de "sop_montaje" como extensión del bloque 3, comparando el modelo con y sin dicha covariable. 
```{r}
...
EL modelo final seleccionado incluye las variables .... y es el siguiente

!!!!!!!!!!!!!!!! hacer bien !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

```{r}
m_final <- glm(
  exito ~ ns(fecha_est, 3) + log_ancho +
    tam_cat + orientacion +
